...
class update_diapers extends StatefulWidget {
  String id1;
  String Productname1;
  ...
  @override
  State<update_diapers> createState() => _update_diapersState();
...
class _update_diapersState extends State<update_diapers> {
  final _formkey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Update Diapers Screen',style: TextStyle(color: Colors.white,fontSize: 30),),
        centerTitle: true,
        backgroundColor: Colors.orange,
        // title: Text('Update Clothing Screen'),
        // centerTitle: true,
