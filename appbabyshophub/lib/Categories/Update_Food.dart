...
class update_Food extends StatefulWidget {
  String id1;
  String Productname1;
  ...
  @override
  State<update_Food> createState() => _update_FoodState();
...
class _update_FoodState extends State<update_Food> {
  final _formkey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Update Food Screen',style: TextStyle(color: Colors.white,fontSize: 30),),
        centerTitle: true,
