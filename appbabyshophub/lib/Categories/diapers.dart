...
class _diapersState extends State<diapers> {
  ...
  void productAddInfo(String imageUrl) async {
    ...
    FirebaseFirestore.instance.collection('DiapersData').add(data);
  }
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 20,
              child: Text(
                "Please fill the details to Adding Diapers Category",
