...
class foods_fetch extends StatefulWidget {
  const foods_fetch({super.key});

  @override
  State<foods_fetch> createState() => _foods_fetchState();
}

class _foods_fetchState extends State<foods_fetch> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Foods Fetch Page", style: TextStyle(color: Colors.white)),
        centerTitle: true,
                                      ...
                                      Column(
                                        children: [
                                          IconButton(onPressed: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => update_Food(
                                          ...
                                          Padding(
                                            ...
                                            child: IconButton(onPressed: (){
                                              FirebaseFirestore.instance.collection('FoodsData').doc(data_id).delete();
