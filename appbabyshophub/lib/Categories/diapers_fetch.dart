...
import 'Update_diapers.dart';

class diapers_fatch extends StatefulWidget {
  const diapers_fatch({super.key});

  @override
  State<diapers_fatch> createState() => _diapers_fatchState();
}

class _diapers_fatchState extends State<diapers_fatch> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Diapers Fetch Page", style: TextStyle(color: Colors.white)),
        centerTitle: true,
                                      ...
                                      Column(
                                        children: [
                                          IconButton(onPressed: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => update_diapers(
                                          ...
                                          Padding(
                                            ...
                                            child: IconButton(onPressed: (){
                                              FirebaseFirestore.instance.collection('DiapersData').doc(data_id).delete();
