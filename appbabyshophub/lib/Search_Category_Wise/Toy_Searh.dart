...
class ToySearch extends StatefulWidget {
  const ToySearch({super.key});

  @override
  State<ToySearch> createState() => _ToySearchState();
}

class _ToySearchState extends State<ToySearch> {
  @override
